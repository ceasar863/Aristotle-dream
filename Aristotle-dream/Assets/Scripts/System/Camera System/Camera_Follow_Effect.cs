...
public class Camera_Follow_Effect : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        player_aristotle = follow_target.GetComponent<Entity_Player_Aristotle>();
        position_composer = current_cinemachine_camera.GetComponent<CinemachinePositionComposer>();
        is_facing_right = player_aristotle.Get_Parameter<bool>("is_facing_right");
    }
    ...
    private void Update()
    {
        ...
        is_falling = player_aristotle.Get_Parameter<bool>("is_falling");
        is_uping = player_aristotle.Get_Parameter<bool>("is_uping");
    }
